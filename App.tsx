...
export class App extends Component<AppProps, AppState> {
      ...
      return <div className="content main">
        <div>
          ...
          <FriendsEditor
            ...
            updateFriends = {this.doUpdateFriendsClick}
          />
        </div>
  ...
  doGetDataJson = (data: unknown): void => {
    ...
    const friends = Array.isArray(data.friends) ? data.friends.filter(f => typeof f === "string") : [];
    this.setState({show: "edit", schedule, savedSchedule: schedule, friends});
  }
  ...
  doUpdateFriendsClick = (newFriends: string[]): void => {
